            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <!-- action="<?=ROOT?>/signup/create" -->
                  <form method="post" action="<?=ROOT?>/signup/create" class="row g-3 needs-validation" novalidate>
                    <div class="col-6">
                      <label for="yourName" class="form-label">First Name</label>
                      <input value="<?= set_value('firstname')?>" type="text"  name="firstname" class="form-control" id="yourFirstNam" required1>
                      <div class="invalid-feedback">Please, enter your name!</div>
                    </div>
                    <div class="col-6">
                      <label for="yourName" class="form-label">Last Name</label>
                      <input value="<?= set_value('lastname')?>" type="text"   name="lastname" class="form-control" id="yourlastname" required1>
                    ...
                    <div class="col-12">
                      ...
                      <input value="<?= set_value('retype_password')?>" type="password" name="retype_password" class="form-control" id="yourRetype" required1>
                      <div class="invalid-feedback">Please enter your Retype Password!</div>
                    </div>

                    <div class="col-12">
                      <div class="form-check">
                        <input value="<?= set_value('terms') ? 'checked':'' ?>" class="form-check-input" name="terms" type="checkbox"  value="1" id="acceptTerms" required1>
